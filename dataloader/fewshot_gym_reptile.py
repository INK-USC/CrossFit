...
from .utils import MyReptileDataset, MyReptileDataLoader

class NLPFewshotGymReptileData(object):
    ...
    def load_dataset(self, tokenizer, do_return=False):
        ...
        preprocessed_path = os.path.join(
            self.data_path,
            self.data_type + "-reptile-{}-{}.json".format(split_identifier, postfix)
        )
        ...
        self.dataset = MyReptileDataset(input_ids, attention_mask,
                                        decoder_input_ids, decoder_attention_mask,
                                        metadata_task, metadata_questions,
                                        inner_bsz=self.args.inner_bsz,
                                        inner_step=self.args.inner_step,
    ...
    def load_dataloader(self, do_return=False):
        self.dataloader = MyReptileDataLoader(self.args, self.dataset, self.is_training)
        if do_return:
