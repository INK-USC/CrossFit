...
from dataloader.fewshot_gym_singletask_template import NLPFewshotGymSingleTaskTemplateData
...
def run(args, logger):
    ...
    train_data = NLPFewshotGymSingleTaskTemplateData(logger, args, args.train_file, data_type="train", is_training=True)
    dev_data = NLPFewshotGymSingleTaskTemplateData(logger, args, args.dev_file, data_type="dev", is_training=False)
    ...
    if args.do_predict:
        ...
        test_data = NLPFewshotGymSingleTaskTemplateData(logger, args, args.test_file, data_type=data_type, is_training=False)
